	...
	*/
	...
	private:
		...
		*/
        ...
        /* ======== IMU Head-tracking 區 ======== */
        std::shared_ptr<HeadPoseReceiver> _receiver;  ///< 背景接收 IMU 封包
        bool        _headTracking = false;            ///< GUI 勾選開關
        HeadPose    _prevPose{};                      ///< 上一幀 IMU 絕對角度，用來算 Δ
        /*  若之後想改回絕對模式，可再加一個 Vector3f _offset 當 Recenter 基準。*/
	};
